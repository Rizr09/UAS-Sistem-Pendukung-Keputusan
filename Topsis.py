...
class Topsis:
    ...
    def getEmbed(self) -> None:
        regex = re.compile(r'https://open.spotify.com/track/(\w+)')
        embed = []
        for i in range(15):
            embed.append(regex.sub(r'https://open.spotify.com/embed/track/\1', self.data['trackUrl'].iloc[i]))
        return embed
